...
#             self.markTgl.Disable()
        ...
        btn_grid.Add(self.removeBtn, (y,4), wx.GBSpan(1,1), flag=wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_CENTER_HORIZONTAL)
        btn_grid.Add(self.cancelBtn, (y,5), wx.GBSpan(1,1), flag=wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_CENTER_HORIZONTAL)
        y = y+1
        btn_grid.Add(self.highlight_on_selection, (y,0), wx.GBSpan(1,1), flag=wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_LEFT)
        ...
        btn_grid.Add(self.zoom_window_size, (y,3), wx.GBSpan(1,1), flag=wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_CENTER_HORIZONTAL)
...
#             self.position_y_value.Disable()
    ...
    def onOpenPeakList(self, evt):
        ...
        if dlg.ShowModal() == wx.ID_CANCEL: return
            ...
            for peak in range(len(peaklist)):
                ...
                else: position = max_value - ((max_value - min_value) / 2)
    ...
    def onChangeParameter(self, evt):
        ...
        ask = panelAsk(self, None, **ask_kwargs)
    ...
    def onItemSelected(self, evt):
        ...
        if color in ["", "None", None]: color = self.config.interactive_ms_annotations_color
        ...
        if self.data_xmin is not None:
            if self.data_xmin > str2num(min_value): return
...
#         except: pass
    ...
    def onAddAnnotation(self, evt):
        ...
        self.kwargs['annotations'][name] = annotation_dict
        self.peaklist.Append(["",min_value, max_value, position, intensity, charge_value, label_value, color_value, str(add_arrow)])
