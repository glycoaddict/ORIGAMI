...
class topPanel(wx.Panel):
    ...
    def makeToolbar(self):
        ...
        self.toolbar.AddTool(ID_removeFilesMenuDT_RT, self.icons.iconsLib['remove16'], 
                             shortHelpString="Remove one from table")
        self.toolbar.AddTool(ID_extractDriftVoltagesForEachIon, self.icons.iconsLib['extract16'], 
                             shortHelpString="Extract drift voltages listed in the table")
        self.toolbar.AddTool(ID_processIons, self.icons.iconsLib['process16'], 
                             shortHelpString="Process ions")
        self.toolbar.AddTool(ID_saveMZList, self.icons.iconsLib['save16'], 
                             shortHelpString="Save current list to .csv files")
        self.toolbar.AddTool(ID_removeAllMZfromList, self.icons.iconsLib['bin16'], 
                             shortHelpString="Clear all ions from the table")
...
class bottomPanel(wx.Panel):
    ...
    def makeToolbar(self):
        ...
        self.toolbar = wx.ToolBar(self, style=wx.TB_HORIZONTAL | wx.TB_DOCKABLE, id = wx.ID_ANY) 
        self.toolbar.SetToolBitmapSize((16, 16)) 
        self.toolbar.AddTool(ID_addFilesMenuDT, self.icons.iconsLib['add16'], 
                             shortHelpString="Add...")
        self.toolbar.AddTool(ID_removeFilesMenuDT, self.icons.iconsLib['remove16'], 
                             shortHelpString="Remove...")
        self.toolbar.AddTool(ID_saveFilesMenuDT, self.icons.iconsLib['save16'], 
